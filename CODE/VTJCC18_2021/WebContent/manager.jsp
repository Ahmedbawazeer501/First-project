...
<body
	style="background-image: url('pexels-pixabay-139398.jpg'); background-repeat: no-repeat;">
		...
		<h1 style="padding: 30px;">Publicly Verifiable Shared Dynamic Electronic Health Record Databases with Functional Commitment Supporting Privacy-Preserving Integrity Auditing</h3>
	</div>
		</h1>
	</div>
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a class="nav-item nav-link active" href="#">Home <span
					...
					class="nav-item nav-link" href="viewgroupmembers.jsp">view Group members</a> 
